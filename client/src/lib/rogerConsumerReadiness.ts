...
export const ENDPOINT_READINESS_MATRIX: EndpointReadinessRow[] = [
  ...
  // ── Batch 29 — Consolidated Return Assembly ────────────────────────────────────────
  {
    ...
    governanceStatus: "B29 Committed — PI 3 planned delivery; contract not yet published",
    blockers: "B26 (Entity Constituents & Allocations) must reach delivery before B29 assembly contract can be drafted",
    platformExists: false,
    rogerCanConsume: false,
  },
  {
    ...
    consumerReadiness: "Future State",
    dataAvailability: "Contract Draft",
    governanceStatus: "B29 Committed — dependent on B26 allocation model delivery",
    blockers: "Depends on B26 Entity Constituents & Allocations (PDC MVP) reaching delivery",
    platformExists: false,
    rogerCanConsume: false,
  },
