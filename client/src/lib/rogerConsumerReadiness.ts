...
export const ENDPOINT_READINESS_MATRIX: EndpointReadinessRow[] = [
  ...
  // ── Batch 8 ──────────────────────────────────────────────────────────────
  {
    ...
    consumerReadiness: "Delivered",
    dataAvailability: "Pipeline Validated",
    governanceStatus: "B8 closed in PI3 on Aug 11, 2026 — delivery recorded",
    blockers: "None recorded for the PI3 closure",
    platformExists: true,
    rogerCanConsume: true,
  },
  {
  ...
  // ── Batch 29 — Consolidated Return Assembly ────────────────────────────────────────
  {
    batch: "B29",
    api: "Consolidated Return — Get Assembly",
    path: "GET /api/v1/consolidated-returns/{id}",
    owner: "TDC",
    rogerCapability: "Filing Review — consolidated entity return assembly and member allocation display",
    consumerReadiness: "Delivered",
    dataAvailability: "Pipeline Validated",
    governanceStatus: "B29 closed in PI3 on Aug 11, 2026 — delivery recorded",
    blockers: "None recorded for the PI3 closure",
    platformExists: true,
    rogerCanConsume: true,
  },
  {
    batch: "B29",
    api: "Consolidated Return — Member Allocation Summary",
    path: "GET /api/v1/consolidated-returns/{id}/members",
    owner: "TDC",
    rogerCapability: "Filing Review — per-member allocation breakdown within consolidated group",
    consumerReadiness: "Delivered",
    dataAvailability: "Pipeline Validated",
    governanceStatus: "B29 closed in PI3 on Aug 11, 2026 — delivery recorded",
    blockers: "None recorded for the PI3 closure",
  ...
  // ── Batch 45 — Rule Logic Expression Table & Adjustment Subtype Domain Expansion ────────
  {
    batch: "B45",
    api: "Rule Logic Expressions — Get by Rule",
    path: "GET /api/v1/rules/{ruleCode}/versions/{version}/expressions",
    owner: "TDC",
    rogerCapability: "Filing Review — surface rule expression build-up alongside mapping proposals and adjustment decisions",
    consumerReadiness: "Future State",
    dataAvailability: "Contract Draft",
    governanceStatus: "B45 Committed — depends on B42 (Tax Rules Framework) delivery",
    blockers: "B42 Tax Rules Framework must be delivered before expression table contract is published; Roger UI surfacing of intermediate expression values is a separate product decision",
    platformExists: false,
    rogerCanConsume: false,
  },
  {
    batch: "B45",
    api: "Adjustment Subtype Reference — Get Approved Values",
    path: "GET /api/v1/reference/adjustment-subtypes",
    owner: "TDC",
    rogerCapability: "Adjustments — populate Subtype dropdown with business-approved values from master workbook",
    consumerReadiness: "Future State",
    dataAvailability: "Contract Draft",
    governanceStatus: "B45 Committed — business-approved subtype values pending confirmation; engineering builds capability, business owns reference data",
    blockers: "Business must confirm approved Adjustment Subtype values (Tax: P, T, Book Addback, Other; Book: AJE, RJE) before reference data can be loaded",
    platformExists: false,
    rogerCanConsume: false,
  },
];
...
export const DEMO_READINESS_TABLE: DemoReadinessRow[] = [
  ...
  },
  {
    ...
    demoReady: "Demo Ready",
    prodReady: "Production Ready",
    demoNotes: "Batch 8 PI3 closure recorded August 11, 2026",
    prodNotes: "B8 closed in PI3 on August 11, 2026; exception tracking delivery recorded",
    batch: "B8",
  },
  {
    ...
    prodReady: "Production Ready",
    demoNotes: "Batch 8 PI3 closure recorded August 11, 2026",
    prodNotes: "B8 closed in PI3 on August 11, 2026; remedy-action delivery recorded",
    batch: "B8",
  },
  {
    ...
    prodReady: "Production Ready",
    demoNotes: "Batch 8 PI3 closure recorded August 11, 2026",
    prodNotes: "B8 closed in PI3 on August 11, 2026; re-ingestion trigger delivery recorded",
    batch: "B8",
  },
  {
