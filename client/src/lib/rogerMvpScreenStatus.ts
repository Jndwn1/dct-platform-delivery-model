...
export const ROGER_SCREEN_STATUS_STORAGE_KEY = "roger-mvp-screen-status-v4";
...
export const ROGER_MVP_SCREEN_RECORDS: RogerMvpScreenRecord[] = [
  ...
  { id: "qa", screen: "QA", deliveryStatus: "Completed", qaReadinessStatus: "Not stated", functionalStatus: "Not stated", dependency: "Calculation updates", devReady: "Aug 28", qaReady: "Aug 28", uatReady: "—", owner: "Roger", notes: "QA team to validate amount calculation.", lastUpdated: SOURCE_UPDATE_DATE },
