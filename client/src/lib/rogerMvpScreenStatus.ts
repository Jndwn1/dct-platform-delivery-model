...
export const ROGER_MVP_SCREEN_RECORDS: RogerMvpScreenRecord[] = [
  ...
  { id: "line-mapping", screen: "Line Mapping", deliveryStatus: "In QA", qaReadinessStatus: "Ready to Test", functionalStatus: "Not stated", dependency: "Override refresh defect", devReady: "Available", qaReady: "Aug 28", uatReady: "Sep 5 (TBD)", owner: "Roger", notes: "Continue tracking the override refresh defect during QA.", lastUpdated: SOURCE_UPDATE_DATE },
  ...
  { id: "line-mapping-page", screen: "Line Mapping Page", deliveryStatus: "Done", qaReadinessStatus: "Partially Ready", functionalStatus: "Not stated", dependency: "Re-approval bug", devReady: "Done", qaReady: "Aug 7", uatReady: "—", owner: "—", notes: "Track the re-approval bug as the remaining issue.", lastUpdated: SOURCE_UPDATE_DATE },
