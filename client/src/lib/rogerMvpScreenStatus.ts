...
export type QAReadinessStatus = "Completed" | "Ready to Test" | "Partially Ready" | "Not Ready" | "Out of Scope" | "Not Functional" | "Not stated";
...
export const QA_READINESS_STATUSES: QAReadinessStatus[] = ["Completed", "Ready to Test", "Partially Ready", "Not Ready", "Out of Scope", "Not Functional", "Not stated"];
export const ROGER_SCREEN_STATUS_STORAGE_KEY = "roger-mvp-screen-status-v5";

const SOURCE_UPDATE_DATE = "Sep 22, 2026";

export const ROGER_MVP_SCREEN_RECORDS: RogerMvpScreenRecord[] = [
  { id: "login", screen: "Login", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "None", devReady: "Available", qaReady: "Aug 28", uatReady: "—", owner: "Roger", notes: "—", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "trial-balance-upload", screen: "Trial Balance Upload", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "None", devReady: "Available", qaReady: "Aug 28", uatReady: "—", owner: "Roger / DCT", notes: "—", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "entity-selection", screen: "Entity Selection", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "None", devReady: "Available", qaReady: "Aug 28", uatReady: "—", owner: "Roger", notes: "—", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "line-mapping", screen: "Line Mapping", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "None", devReady: "Available", qaReady: "Aug 28", uatReady: "—", owner: "Roger", notes: "—", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "qa", screen: "QA", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "Calculation updates", devReady: "Aug 28", qaReady: "Aug 28", uatReady: "—", owner: "Roger", notes: "QA team to validate amount calculation.", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "my-clients", screen: "My Clients Page", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "None", devReady: "Available", qaReady: "Aug 28", uatReady: "—", owner: "DCT / Nasar", notes: "—", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "return-structure", screen: "Return Structure Management", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "None", devReady: "Available", qaReady: "Aug 28", uatReady: "—", owner: "Roger / DCT", notes: "—", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "return-filing", screen: "Return Filing Page", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "Issue Count", devReady: "Aug 26", qaReady: "Aug 28", uatReady: "—", owner: "DCT / Nasar", notes: "The Total Returns and Total Entities KPIs are unavailable because they are missing from the API response. Confirm API availability for Average Completion and Completed Returns. Return Structure count is not displaying correctly and needs confirmation on the structure-creation status. Has Members is unavailable. Issue Count is TBD.", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "summary-consolidation", screen: "Summary Page — Inside Consolidation", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "Consolidations, Eliminations, PY Data", devReady: "Aug 28", qaReady: "Aug 28", uatReady: "—", owner: "TDC / Gateway", notes: "Gateway is still pending while TDC is ready. The UI is ready except for PY data, and there are no changes from Gateway. Most data points and the UI are complete through API aside from PY data. “Before NOL and special deduction” and “Net operating loss deduction” are confirmed as Not in MVP Scope.", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "line-mapping-page", screen: "Line Mapping Page", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "None", devReady: "Available", qaReady: "Available", uatReady: "—", owner: "—", notes: "—", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "tb-line-mapping", screen: "TB With Line Mapping", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "None", devReady: "Available", qaReady: "Aug 28", uatReady: "—", owner: "—", notes: "—", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "book-reclass-adjustments", screen: "Book/Reclass Adjustments", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "None", devReady: "Available", qaReady: "Aug 28", uatReady: "—", owner: "Process", notes: "—", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "book-return-review", screen: "Book Return Review", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "PY Data", devReady: "Aug 28", qaReady: "Aug 28", uatReady: "—", owner: "DCT", notes: "The UI is not currently using the Gateway endpoint and PY remains pending. Line and PY Final Amount are unavailable through the API. Adjustments are not appearing on review, so an updated API is needed to identify the category, such as income or deduction, associated with each line item.", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "tax-adjustment", screen: "Tax Adjustment", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "Gateway API, Pending", devReady: "Aug 28", qaReady: "Aug 28", uatReady: "—", owner: "DCT", notes: "Adjustments are coming through correctly and can be updated. Adjustment Rules data still needs confirmation. Ramesh noted that the rule data remains in an invalid state and needs review by Krista. Account Name and Book Balance ($) are unavailable through API. MP-04 gift expense and MP-01 meals expense adjustment-rule fields show API Integration status as Unavailable. Adjustments data, Total Debit, and Total Credit are also unavailable through API.", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "book-tax-report", screen: "Book to Tax Report", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "Gateway API and PY Data", devReady: "Aug 28", qaReady: "Aug 28", uatReady: "—", owner: "DCT", notes: "Continue using the same endpoint as Book Return Review. PY remains pending and Tax Adjustment Amounts are also pending. Gateway currently returns: “No assembled consolidated return found for consolidationId, taxYear 2025.” Prior-Year Final Amount is unavailable and the amount hyperlink breakdown details still need to be provided.", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "book-tax-reconciliation", screen: "Book to Tax Reconciliation", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "Display on UI", devReady: "Aug 28", qaReady: "Aug 28", uatReady: "—", owner: "DCT", notes: "Awaiting Process team confirmation before adding tags to taxonomy accounts that drive net income calculations for the BTT Reconciliation report. Gateway is now up and running. Subtotals for Add-Back, Permanent, and Temporary Adjustments, along with Book Income Total and Taxable Income, are visible in the UI but remain unavailable through API and are pending Gateway API support.", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "1120-form", screen: "1120 Form", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "M-1 Line Mapping, M-2 Line Mapping", devReady: "Aug 28", qaReady: "Aug 28", uatReady: "—", owner: "DCT", notes: "M-1 is not ready. Form 4562 is confirmed as Not Applicable for MVP and should be removed from the UI. Validate that the numbers are flowing correctly. Line, Description, and Final Tax Amount are not available for Schedule M-1 and M-2.", lastUpdated: SOURCE_UPDATE_DATE },
  { id: "sign-off", screen: "Sign Off", deliveryStatus: "Completed", qaReadinessStatus: "Completed", functionalStatus: "Not stated", dependency: "Gateway API, Integration and Testing Pending", devReady: "Aug 28", qaReady: "Aug 28", uatReady: "—", owner: "DCT / Roger UI", notes: "The API is confirmed ready to support both profile determination and entity characteristics. The Sign Off page still depends on DCT and Roger UI. Validate the UI flow first, including the skeleton, and then provide the required inputs. Track defect #1450692 — Sign-off failing for entity 4008715, TY2025; PDC missing ENTITY_TYPE, which blocks Profile Determinations.", lastUpdated: SOURCE_UPDATE_DATE },
];
...
export function getRogerScreenReadinessSummary(records: RogerMvpScreenRecord[] = ROGER_MVP_SCREEN_RECORDS) {
  return {
    ...
    completed: countBy(records, "qaReadinessStatus", "Completed"),
