  ...
  gates: [
    {
      ...
      artifacts: [
        ...
        { id: "SLC-001", name: "Schema Lock Certificates", status: "ISSUED", issuedDate: "2026-05-21", issuedBy: "Architecture Lead" },
        { id: "QA-SV-001", name: "QA Schema Validation Report", status: "ISSUED", issuedDate: "2026-05-21", issuedBy: "QA Engineer" },
      ]
    },
    {
      id: "G2",
      ...
      lastUpdated: "2026-05-21",
      artifacts: [
        { id: "IDD-001", name: "Invariant Definition Documents", status: "ISSUED", issuedDate: "2026-04-30", issuedBy: "Tax Domain Lead" },
        { id: "IVR-001", name: "Invariant Validation Reports", status: "ISSUED", issuedDate: "2026-05-10", issuedBy: "Architecture Lead" },
        { id: "ILR-001", name: "Invariant Lock Records", status: "ISSUED", issuedDate: "2026-05-21", issuedBy: "Tax Domain Lead + Architecture Lead" },
        { id: "QA-IV-001", name: "QA Invariant Validation Report", status: "ISSUED", issuedDate: "2026-05-21", issuedBy: "QA Engineer" },
      ]
    },
    {
      id: "G3",
      ...
      artifacts: [
        { id: "LMD-001", name: "Lineage Map Drafts (B10 — Jun 11)", status: "ISSUED", issuedDate: "2026-06-11", issuedBy: "PDC Workstream Lead" },
        { id: "LR-001", name: "Lineage Records (B10 — Jun 11)", status: "ISSUED", issuedDate: "2026-06-11", issuedBy: "PDC Workstream Lead" },
        { id: "DAC-001", name: "Dataset Authority Certificates", status: "PENDING" },
...
export const allBatches: ArchitecturalBatch[] = [
  ...
  },
  {
    ...
    primarySystem: "PDC (Ocelot Gateway)",
    keyGate: "G3 — Contract Publication",
    entryCondition: "AB-08 PDC complete",
    exitCondition: "Gateway Read Contract published; IMS, CEM, TIM pass-through surfaces live; Roger and all consumers call gateway — not underlying systems directly",
    batchLead: "PDC Workstream Lead",
    openIssues: 0,
    completionPct: 80,
    ...
    stories: [
      "Ocelot Gateway Scaffolding & Governed Consumer Access Layer",
      "IMS Pass-Through Surface",
      "CEM Pass-Through Surface",
      "TIM Pass-Through Surface",
      "Gateway Read Contract Publication (Roger Consumer Surface)",
    ],
    outcomes: [
      "Call the gateway from a Roger test client and show IMS prior year tax return data returned via pass-through",
      "Call the CEM pass-through and show client authorization data returned without PDC storing it",
      "Show the gateway auth and routing layer blocking an unauthenticated request",
      "Trigger a TIM pass-through and show engagement metadata returned without PDC storage",
      "Demonstrate no IMS, TIM, or CEM data persistence inside PDC",
      "Show the Gateway Read Contract as the versioned, additive-only consumer surface",
    ],
    gates: []
  },
  {
