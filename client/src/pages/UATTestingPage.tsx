            ...
            <table style={{ width: "100%", borderCollapse: "collapse" as const, fontSize: 12 }}>
              ...
              <tbody>
                {[
                  ...
                  { milestone: "All MVP Code Deployed to QA",    date: "Aug 7",   status: "🟡", owner: "DCT", risk: "Low",    notes: "Official deployment of the latest MVP code to the QA environment is scheduled for Aug. 7." },
                  { milestone: "All MVP Code Available in UAT",  date: "TBD",     status: "⚪", owner: "DCT", risk: "Medium", notes: "UAT environment currently contains a previous deployment. Official deployment of the latest MVP build has not yet been scheduled." },
