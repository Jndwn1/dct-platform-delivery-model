...
const BATCH_REFERENCE = [
  ...
  { pi: "PI 3", status: "Done",        batchNum: "MVP", platform: "TDC",     name: "MVP Enhancements",  whatItDoes: "Delivers the current Rule Logic Expression Table and Adjustment Subtype enhancements for the MVP experience.",               rogerImpact: "Filing Review + Adjustments screen + Master Workbook import" },
