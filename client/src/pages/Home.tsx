...
const BATCH_REFERENCE = [
  ...
  { pi: "PI 2", status: "In Progress", batchNum: "10", platform: "TDC", name: "Return Assembly, Filing & Lineage", whatItDoes: "Assembles return and filing records and anchors lineage.", rogerImpact: "Form 1120 / Filing (Stage 10)" },
