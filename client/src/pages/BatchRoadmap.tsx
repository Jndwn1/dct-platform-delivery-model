...
const EPIC_INDEX: { batch: string; name: string; features: string }[] = [
  ...
  { batch: "B9",  name: "Roger Gateway & Governed Consumer Access Layer",         features: "Roger Gateway & Governed Consumer Access Layer (PDC, PI 2, 5/31–6/12) + Rollforward & Prior Year Intelligence — ON HOLD (TDC, absorbed by B31)" },
