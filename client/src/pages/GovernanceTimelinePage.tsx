...
const TIMELINE_EVENTS = [
  ...
  { date: "2025-Q1", label: "Batch 1 — File Ingestion & Initial Storage", type: "batch", status: "complete", description: "Tax Portal ingestion gate, Service Bus event publication, PDC IngestionJob and SourceFile records.", gate: null },
  { date: "2025-Q2", label: "Batch 2 — Normalization & Cross-LOB Taxonomy", type: "batch", status: "active", description: "Normalization pipeline, canonical dataset creation, Cross-LOB taxonomy definitions.", gate: null },
  ...
  { date: "2025-Q3", label: "Batch 3 — Tax Domain Authority & Tax Taxonomy", type: "batch", status: "planned", description: "TDC established as tax system of record. Tax taxonomy and jurisdiction codes defined.", gate: null },
  { date: "2025-Q3", label: "Batch 4 — AI Tax Mapping & Explainability", type: "batch", status: "planned", description: "AI Orchestrator produces tax mapping proposals with confidence scores and evidence.", gate: null },
  ...
  { date: "2025-Q4", label: "Batch 5 — Mapping Decisions & Governance", type: "batch", status: "planned", description: "Practitioner review workflow. Tax decision persistence. Immutable audit trail.", gate: null },
  { date: "2025-Q4", label: "Batch 6 — Practitioner Review & Adjustment Workflow", type: "batch", status: "planned", description: "Roger UI adjustment workflow. Practitioner approval and override capabilities.", gate: null },
  ...
  { date: "2026-Q1", label: "Batch 7 — Rollforward & Prior Year Intelligence", type: "batch", status: "planned", description: "Prior year data rollforward. AI-assisted prior year comparison.", gate: null },
  { date: "2026-Q2", label: "Batch 8 — Return Assembly, Filing & Lineage Closure", type: "batch", status: "planned", description: "Tax return assembly. Filing integration. Full lineage closure.", gate: null },
];
