...
const TIMELINE_EVENTS = [
  ...
  { date: "2025-Q2", label: "Batch 2A — Orchestrator Contract Enforcement & Classification", type: "batch", status: "active", description: "Contract enforcement layer between Orchestrator and PDC. FirmTaxonomyId required on every record. Classification rejection, deterministic validation, and audit log. Blocking gap: Orchestrator not yet returning classification. PI 1 → PI 2.", gate: null },
  ...
  { date: "2026-Q3", label: "Batch 8 — Exceptions & Remediation", type: "batch", status: "done", description: "Structured exception tracking across ingestion, normalization, mapping, and workflow. Batch 8 closed in PI3 on August 11, 2026.", gate: null },
