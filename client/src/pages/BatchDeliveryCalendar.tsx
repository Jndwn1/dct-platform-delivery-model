          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
            ...
            <div>
              ...
              {[
                ...
                { status: "Baseline MVP", count: "11", detail: "Historical PI3 planning scope — not the current ADO pipeline. See the Platform Dashboard for 10 Active / 0 In Review.", color: "#7c3aed", bg: "#ede9fe" },
