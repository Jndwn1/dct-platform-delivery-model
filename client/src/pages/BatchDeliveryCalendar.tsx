...
const BASELINE_ROWS: BatchRow[] = [
  ...
  },
  {
    ...
    name: "Exceptions & Remediation",
    startDate: "2026-05-12", endDate: "2026-05-20", status: "Committed",
    notes: "Batch 8 TDC. Exceptions and remediation — TDC side. Parallel with B8 PDC.", dependsOn: "B8",
  },
  {
  ...
  },
  {
    ...
    startDate: "2026-05-21", endDate: "2026-06-02", status: "Committed",
    notes: "Batch 9 TDC. Rollforward and prior year intelligence. Parallel with B9 PDC.", dependsOn: "B9",
  },
  {
    ...
    notes: "Batch 10 TDC. Return assembly, filing, and lineage closure. Requires B6 review lock and B9 prior year intelligence.", dependsOn: "B6,B9",
  },
  {
    ...
    notes: "Batch 11 TDC. Learning governance and model evolution. Requires B10 return assembly complete.", dependsOn: "B10",
  },
  // ── PI 2 — Stretch ───────────────────────────────────────────────────────────
  {
    ...
    notes: "Batch 24 PDC. PI 2 Stretch. Advisory opportunity reference data — governance framework and cross-LOB scoring rules.", dependsOn: "B11",
  },
  {
    ...
    notes: "Batch 25 PDC. PI 2 Stretch. Advisory opportunity detection and surfacing — PDC consumer-initiated detection framework.", dependsOn: "B24",
  },
  {
    id: "pi2s-b16-pdc", pi: "PI 2 Stretch", batch: "B16", system: "PDC",
    name: "Audit Trail & Lineage Governance",
    startDate: "2026-06-25", endDate: "2026-07-03", status: "Stretch",
    notes: "Batch 16 PDC. PI 2 Stretch. Audit trail and lineage governance — PDC side. Feeds B16 TDC in PI 3.", dependsOn: "B11",
  },
  // ── PI 3 ─────────────────────────────────────────────────────────────────────
  {
    ...
    notes: "Batch 14 TDC. Tax computation rules and formula governance. Governed formula registry.", dependsOn: "B11",
  },
  {
    ...
    notes: "Batch 12 PDC. TIM integration and engagement operations. PDC-only integration point for TIM operational data.", dependsOn: "B11",
  },
  {
    ...
    notes: "Batch 15 TDC. Tax provision reference data and ASC 740 authority.", dependsOn: "B14",
  },
  {
    ...
    notes: "Batch 13 PDC. Platform reference and document provenance.", dependsOn: "B12",
  },
  {
    ...
    notes: "Batch 18 TDC. Provision computation, DTA/DTL, and ETR reconciliation.", dependsOn: "B15",
  },
  {
    ...
    notes: "Batch 22 PDC. Client communication and outstanding items.", dependsOn: "B13",
  },
  {
    ...
    notes: "Batch 19 TDC. Provision workflow, sign-off, and cross-LOB output.", dependsOn: "B18",
  },
  {
    ...
    notes: "Batch 20 PDC. Firm governance and professional standards.", dependsOn: "B22",
  },
  {
    id: "pi3-b24-tdc", pi: "PI 3", batch: "B24", system: "TDC",
    name: "Advisory Opportunity Reference Data",
    startDate: "2026-08-04", endDate: "2026-08-12", status: "MVP",
    notes: "Batch 24 TDC. Advisory opportunity reference data — tax-specific advisory logic and TDC tax detection rules. Follows B24 PDC (PI 2 Stretch).", dependsOn: "B19",
  },
  {
  ...
  },
  {
    ...
    notes: "Batch 25 TDC. Advisory opportunity detection and surfacing — TDC tax-flavored detection. Follows B25 PDC (PI 2 Stretch).", dependsOn: "B24",
  },
  {
    ...
    notes: "Batch 23 PDC. Benchmark and peer analytics.", dependsOn: "B21",
  },
  {
    ...
    notes: "Batch 17 TDC. Decision support — overrides, evidence, and workpapers.", dependsOn: "B25",
  },
  {
    id: "pi3-b16-tdc", pi: "PI 3", batch: "B16", system: "TDC",
    name: "Audit Trail & Lineage Governance",
    startDate: "2026-09-02", endDate: "2026-09-11", status: "MVP",
    notes: "Batch 16 TDC. Audit trail and lineage governance — TDC side. Follows B16 PDC (PI 2 Stretch, 6/25–7/3).", dependsOn: "B17",
  },
  // ── PI 4 — Program Close ──────────────────────────────────────────────────────
  {
    ...
    notes: "Batch 21 TDC. PI 4 program close. Quality control review records.", dependsOn: "B16",
  },
];
// ─── COLORS ───────────────────────────────────────────────────────────────────
