...
const CORE_CAPABILITIES = [
  ...
  { id: "adjustments",  icon: "±",  title: "Tax Adjustment Engine",   color: "#059669", desc: "Applies system-level tax adjustments and accepts practitioner-created or eligible rule-generated adjustments from Roger. Roger indicates that posted rule results create DRAFT adjustments; the exact TDC persistence and payload structure remains in discovery validation." },
