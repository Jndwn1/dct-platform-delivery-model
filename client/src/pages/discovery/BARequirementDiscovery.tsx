...
const LIFECYCLE_STEPS = [
  ...
  },
  {
    ...
    color: "#7c3aed",
    icon: "🔍",
    desc: "DCT runs AI-assisted gap analysis against existing platform contracts and capabilities. Each requirement is classified as: Covered (integration starts immediately), Partially Covered (scoping agreement produced), or Not-New (DCT authors the build spec).",
...
const GAP_CLASSIFICATIONS = [
  ...
  },
  {
    ...
    border: "#fde68a",
    icon: "~",
    desc: "The platform partially satisfies the requirement. DCT produces a scoping agreement showing what is covered and what is not-new. You see what DCT will build before it is built.",
    action: "Review scoping agreement. Confirm not-new scope before build begins.",
  },
  {
    label: "Not-New",
    color: "#2563eb",
...
const DISCOVERY_QUESTIONS: { category: string; color: string; icon: string; questions: string[] }[] = [
  ...
  },
  {
    ...
    icon: "🔍",
    questions: [
      "Is this requirement Covered, Partially Covered, or Not-New?",
      "If Covered — which existing contract satisfies this?",
      "If Partially Covered — what is the not-new scope?",
      "If Not-New — are the DCT assumptions correct?",
