...
const TERMS: GlossaryTerm[] = [
  {
    ...
    definition: "Platform Data Cloud. The financial truth layer of the DCT ecosystem. PDC ingests raw financial data from client ERP systems, normalizes it against a canonical model, assigns entities and reporting periods, and produces the authoritative financial record consumed by TDC.",
  ...
  },
  {
    ...
    definition: "Tax Data Cloud. Also referred to as DCT (Data Consolidation Team). The tax transformation platform that receives normalized financial data from PDC and applies tax rules, mappings, adjustments, and classifications to produce tax-ready data. TDC is the system of record for all tax data.",
