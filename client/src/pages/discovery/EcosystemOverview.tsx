...
const PLATFORMS: PlatformDetail[] = [
  {
    ...
    consumers: ["PDC (Platform Data Cloud)"],
  ...
  },
  {
    ...
    consumers: ["Roger", "GoSystem Tax", "Downstream reporting"],
  ...
  },
  {
    ...
    borderColor: "#d97706",
    icon: "📋",
    responsibilities: ["Federal return preparation", "State return preparation", "Form generation", "Schedule preparation", "Filing package assembly"],
