...
const PLATFORM_ITEMS: NavItem[] = [
  ...
  { label: "Learning Center", path: "/learning-center", icon: "📚", badge: "NEW", badgeColor: "#7c3aed" },
...
const EXECUTIVE_HEALTH_ITEMS = workspaceShortcuts("executive", ["Executive Health", "Post Pilot", "Ask Buddy"], false);
const DELIVERY_MANAGEMENT_ITEMS = workspaceShortcuts("delivery", ["Delivery Calendar", "Current Pipeline", "PI4 Sprint Tracker", "Delivery Assurance"]);
