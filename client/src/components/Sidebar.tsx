...
const BA_ITEMS: NavItem[] = [
  ...
  { label: "QA Deployment Registry",       path: "/qa-deployment-registry",     icon: "🧪", badge: "New",     badgeColor: "#7c3aed" },
  { label: "QA Release Notes Simulation",  path: "/qa-release-sim",             icon: "▶️", badge: "Sim",     badgeColor: "#7c3aed" },
