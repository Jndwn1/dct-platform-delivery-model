...
export default function DCTSummaryAgent() {
  ...
  const sendEmail = () => {
    ...
    const subjectMap: Record<string, string> = {
      ba:   "DCT Platform — BA Operational Summary",
      po:   "DCT Platform — PO Executive Summary",
      arch: "DCT Platform — Architecture Governance Summary",
      demo: "DCT Platform — Demo Readiness Assessment",
      adr:  "DCT Platform — ADR Candidates for Review",
    };
    const subject = encodeURIComponent(subjectMap[summary.type as string] ?? "DCT Platform Summary");
    const scores = `Confidence: ${summary.confidenceScore}/100 | Readiness: ${summary.readinessScore}/100 | Governance: ${summary.governanceScore}/100`;
    const body = encodeURIComponent(
      ...
      "\n\n---\nGenerated by DCT Platform Gate Verification Dashboard"
    );
            ...
            <div style={{ padding: "14px 16px", borderBottom: "1px solid #f3f4f6" }}>
              ...
              {summary && !generating && (
                <div style={{ display: "flex", gap: "8px", marginTop: "10px" }}>
                  ...
                  <button onClick={sendEmail} style={{ flex: 1, padding: "7px", borderRadius: "6px", border: "1px solid #bfdbfe", backgroundColor: "#eff6ff", color: "#1d4ed8", fontSize: "11px", fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "4px" }}>
                    ✉ Email Summary
                  </button>
                </div>
              )}
