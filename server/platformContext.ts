...
export function buildPlatformSystemPrompt(liveSnapshot?: LiveSnapshotInput): string {
  ...
  if (liveSnapshot) {
    ...
    lines.push(`- PI 4 — Post Pilot: 3 of 5 source-confirmed features are closed (60%); 2 remain planned. PI4 remains excluded from MVP delivery, completion, readiness, denominator, and KPI calculations.`);
