...
export function buildPlatformSystemPrompt(liveSnapshot?: LiveSnapshotInput): string {
  ...
  if (liveSnapshot) {
    ...
    lines.push(`- PI 4 — Post Pilot: 3 of 5 source-confirmed features are closed (60%); 2 remain active. These PI4 features are included in the governed MVP delivery population.`);
