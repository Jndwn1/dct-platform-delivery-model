...
describe("PI4 Post Pilot delivery", () => {
  ...
  it("moves the PI4 planning card from the landing page to the dedicated Post Pilot page", () => {
    ...
    expect(prototypeFlow).toContain("Roger End-to-End Operating Flow");
    expect(prototypeFlow).toContain("State and Provision workstreams progress with the TDC / DCT and shared data workstreams");
    expect(prototypeFlow).toContain("B9A Gateway and IMS");
    expect(prototypeFlow).toContain("GoSystem and iTax");
    expect(prototypeFlow).toContain("roger-post-pilot-end-to-end-executive-flow_f73fea32.png");
    expect(prototypeFlow).toContain("Open full-size diagram");
    expect(prototypeFlow).toContain('minWidth: "1560px"');
    expect(prototypeFlow).toContain("Authority boundary:");
    expect(prototypeFlow).not.toContain("ExecutiveProcessFlow");
