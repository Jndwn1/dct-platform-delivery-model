...
describe("PI4 Post Pilot delivery", () => {
  ...
  it("moves the PI4 planning card from the landing page to the dedicated Post Pilot page", () => {
    ...
    expect(deploymentSnapshot).toContain("POST_PILOT_DEPLOYMENT_BASELINE");
    expect(deploymentSnapshot).toContain("total: 0");
    expect(deploymentSnapshot).toContain("production: 0");
    expect(deploymentSnapshot).toContain("pdc: 0");
    expect(deploymentSnapshot).toContain("tdc: 0");
    expect(deploymentSnapshot).toContain("rollbackCandidates: 0");
    ...
    expect(deploymentSnapshot).not.toContain("trpc.deploymentRegistry");
